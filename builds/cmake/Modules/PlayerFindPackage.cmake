...
function(player_find_package)
	...
	if(${PLAYER_FIND_PACKAGE_CONDITION})
		...
		if (${${FIND_PACKAGE_NAME}_FOUND})
			target_link_libraries(${PROJECT_NAME}_Static ${PLAYER_FIND_PACKAGE_TARGET})
			if(PLAYER_FIND_PACKAGE_DEFINITION)
				target_compile_definitions(${PROJECT_NAME}_Static PUBLIC ${PLAYER_FIND_PACKAGE_DEFINITION}=1)
			endif()
		endif()
	endif()
