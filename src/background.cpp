...
Background::Background(const std::string& name) : Drawable(TypeBackground, Priority_Background)
{
...
Background::Background(int terrain_id) : Drawable(TypeBackground, Priority_Background)
{
	DrawableMgr::Register(this);
