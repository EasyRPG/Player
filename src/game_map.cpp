...
template bool Game_Map::CheckOrMakeWayEx<true, Game_Map::eImpl_AssertWay>(const Game_Character& self, int, int, int, int, lcf::Span<int>);
...
template bool Game_Map::CheckOrMakeWayEx<false, Game_Map::eImpl_AssertWay>(const Game_Character& self, int, int, int, int, lcf::Span<int>);
