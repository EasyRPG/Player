...
{
  Event_comand_Change_experience comand;
  comand.Comand=Command;
  comand.Depth=Depth;
                          ChunkInfo.Length= ReadCompressedInteger(Stream); 	// longitud 00
                           ChunkInfo.Length= ReadCompressedInteger(Stream); // longitud 07
...
Event_comand stEvent::EventcommandCall_Shop(int Command,int Depth,FILE * Stream) {
   Event_comand_Call_Shop comand; int itemasnum,dat;
...
std:: vector <Event_comand> stEvent::EventcommandChunk(FILE * Stream)//instrucciones de la paguina
{
         ...
         ChunkInfo.ID= ReadCompressedInteger(Stream); //de
         depth=ReadCompressedInteger(Stream); //profundidad
         if(ChunkInfo.ID!=0)
         {       while(ChunkInfo.ID!=0)
                {

                    printf(" Main ChunkInfo.ID %04X  ",ChunkInfo.ID);
                         switch(ChunkInfo.ID)// tipo de la primera dimencion
                         {
                     case Message:// llamar una funcion con el id que retorne un objeto comando
                           vcEvent_comand.push_back(EventcommandMessageChunk(ChunkInfo.ID,depth,Stream));
                           break;
                     case Add_line_to_message:// 0x819D0E,
                           vcEvent_comand.push_back(EventcommandMessageChunk(ChunkInfo.ID,depth,Stream));
                           break;
                     case Message_options:// 0xCF08,
                          vcEvent_comand.push_back(EventcommandMessageoptionsChunk(ChunkInfo.ID,depth,Stream));
                          break;
                     case Select_message_face:// 0xCF12,
                          vcEvent_comand.push_back(EventcommandSelectfaceChunk(ChunkInfo.ID,depth,Stream));
                          break;
                     case Show_choice:// 0xCF1C,
                          vcEvent_comand.push_back(EventcommandShowchoiceChunk(ChunkInfo.ID,depth,Stream));
                          break;
                     case Nested_block:// 0x0A
                          vcEvent_comand.push_back(EventcommandSimpleEvent_comand(ChunkInfo.ID,depth,Stream));
                          break;
                     case Show_choice_option:// 0x819D2C,
                          vcEvent_comand.push_back(EventcommandShow_choice_option(ChunkInfo.ID,depth,Stream));
                          break;
                     case End_Choice_block:// 0x819D2D,
                          vcEvent_comand.push_back(EventcommandSimpleEvent_comand(ChunkInfo.ID,depth,Stream));
                          break;
                     case Number_input:// 0xCF26,
                          vcEvent_comand.push_back(EventcommandNumber_input(ChunkInfo.ID,depth,Stream));
                          break;
                     case Change_switch:// 0xCF62,
                          vcEvent_comand.push_back(EventcommandChange_switch(ChunkInfo.ID,depth,Stream));
                          break;
                     case Change_var:// 0xCF6C,
                          vcEvent_comand.push_back(EventcommandChange_var(ChunkInfo.ID,depth,Stream));
                          break;
                     case Timer_manipulation:// 0xCF76,
                          vcEvent_comand.push_back(EventcommandTimer_manipulation(ChunkInfo.ID,depth,Stream));
                          break;
                     case Change_cash_held:// 0xD046,
                          vcEvent_comand.push_back(EventcommandChange_cash_held(ChunkInfo.ID,depth,Stream));
                          break;
                     case Change_inventory:// 0xD050,
                          vcEvent_comand.push_back(EventcommandChange_inventory(ChunkInfo.ID,depth,Stream));
                          break;
                     case Change_party:// 0xD05A,
                          vcEvent_comand.push_back(EventcommandChange_party(ChunkInfo.ID,depth,Stream));
                          break;
                     case Change_experience:// 0xD12A,
                          vcEvent_comand.push_back(EventcommandChange_experience(ChunkInfo.ID,depth,Stream));
                          break;
                     case Change_level:// 0xD134,
                          vcEvent_comand.push_back(EventcommandChange_level(ChunkInfo.ID,depth,Stream));
                          break;
                     case Change_statistics:// 0xD13E,
                          vcEvent_comand.push_back(EventcommandChange_statistics(ChunkInfo.ID,depth,Stream));
                          break;
                     case Learn_forget_skill:// 0xD148,
                          vcEvent_comand.push_back(EventcommandLearn_forget_skill(ChunkInfo.ID,depth,Stream));
                          break;
                          case Change_equipment:// 0xD152,
                               vcEvent_comand.push_back(EventcommandChange_equipment(ChunkInfo.ID,depth,Stream));
                               break;
                          case Change_HP:// 0xD15C,
                               vcEvent_comand.push_back(EventcommandChange_HP(ChunkInfo.ID,depth,Stream));
                               break;
                          case Change_MP:// 0xD166,
                               vcEvent_comand.push_back(EventcommandChange_MP(ChunkInfo.ID,depth,Stream));

                               break;
                          case Change_Status:// 0xD170,
                               vcEvent_comand.push_back(EventcommandChange_Status(ChunkInfo.ID,depth,Stream));

                               break;
                          case Full_Recovery:// 0xD17A,
                               vcEvent_comand.push_back(EventcommandFull_Recovery(ChunkInfo.ID,depth,Stream));

                               break;
                          case Inflict_Damage:// 0xD204,
                               vcEvent_comand.push_back(EventcommandInflict_Damage(ChunkInfo.ID,depth,Stream));

                               break;
                          case Change_Hero_Name:// 0xD272,
                               vcEvent_comand.push_back(EventcommandChange_Hero_Name(ChunkInfo.ID,depth,Stream));
                               break;
                          case Change_Hero_Class:// 0xD27C,
                               vcEvent_comand.push_back(EventcommandChange_Hero_Class(ChunkInfo.ID,depth,Stream));
                               break;
                          case Change_Hero_Graphic:// 0xD306,
                               vcEvent_comand.push_back(EventcommandChange_Hero_Graphic(ChunkInfo.ID,depth,Stream));

                               break;
                          case Change_Hero_Face:// 0xD310,
                               vcEvent_comand.push_back(EventcommandChange_Hero_Face(ChunkInfo.ID,depth,Stream));

                               break;
                          case Change_Vehicle:// 0xD31A,
                               vcEvent_comand.push_back(EventcommandChange_Vehicle(ChunkInfo.ID,depth,Stream));

                               break;
                          case Change_System_BGM:// 0xD324,
                               vcEvent_comand.push_back(EventcommandChange_System_BGM(ChunkInfo.ID,depth,Stream));

                               break;
                          case Change_System_SE:// 0xD32E,
                               vcEvent_comand.push_back(EventcommandChange_System_SE(ChunkInfo.ID,depth,Stream));

                               break;
                          case Change_System_GFX:// 0xD338,
                               vcEvent_comand.push_back(EventcommandChange_System_GFX(ChunkInfo.ID,depth,Stream));

                               break;
                          case Change_Transition:// 0xD342,
                               vcEvent_comand.push_back(EventcommandChange_Transition(ChunkInfo.ID,depth,Stream));

                               break;
                          case Start_Combat:// 0xD356,
                               vcEvent_comand.push_back(EventcommandStart_Combat(ChunkInfo.ID,depth,Stream));
                               break;

                          case Call_Shop:// 0xD360,
                               vcEvent_comand.push_back(EventcommandCall_Shop(ChunkInfo.ID,depth,Stream));
                          ...
                          case Call_Inn:// 0xD36A,
                               vcEvent_comand.push_back(EventcommandCall_Inn(ChunkInfo.ID,depth,Stream));
                          ...
                          case Enter_hero_name:// 0xD374,
                               vcEvent_comand.push_back(EventcommandEnter_hero_name(ChunkInfo.ID,depth,Stream));

                               break;
                          case Teleport_Party:// 0xD34A	,
                               vcEvent_comand.push_back(EventcommandTeleport_Party(ChunkInfo.ID,depth,Stream));

                               break;
                          case Store_hero_location:// 0xD444,
                               vcEvent_comand.push_back(EventcommandStore_hero_location(ChunkInfo.ID,depth,Stream));

                               break;
                          case Recall_to_location:// 0xD44E,
                               vcEvent_comand.push_back(EventcommandRecall_to_location(ChunkInfo.ID,depth,Stream));
                          ...
                          case Teleport_Vehicle:// 0xD462,
                               vcEvent_comand.push_back(EventcommandTeleport_Vehicle(ChunkInfo.ID,depth,Stream));

                               break;
                          case Teleport_Event:// 0xD46C,
                               vcEvent_comand.push_back(EventcommandTeleport_Event(ChunkInfo.ID,depth,Stream));

                               break;
                          case Swap_Event_Positions:// 0xD476,
                               vcEvent_comand.push_back(EventcommandSwap_Event_Positions(ChunkInfo.ID,depth,Stream));

                               break;
                          case Get_Terrain_ID:// 0xD51E,
                               vcEvent_comand.push_back(EventcommandGet_Terrain_ID(ChunkInfo.ID,depth,Stream));

                               break;
                          case Get_Event_ID:// 0xD528,
                               vcEvent_comand.push_back(EventcommandGet_Event_ID(ChunkInfo.ID,depth,Stream));

                               break;
                          case Erase_screen:// 0xD602,
                               vcEvent_comand.push_back(EventcommandErase_screen(ChunkInfo.ID,depth,Stream));

                               break;
                          case Show_screen:// 0xD60C,
                               vcEvent_comand.push_back(EventcommandShow_screen(ChunkInfo.ID,depth,Stream));

                               break;
                          case Set_screen_tone:// 0xD616,
                               vcEvent_comand.push_back(EventcommandSet_screen_tone(ChunkInfo.ID,depth,Stream));

                               break;
                          case Flash_screen:// 0xD620,
                               vcEvent_comand.push_back(EventcommandFlash_screen(ChunkInfo.ID,depth,Stream));

                               break;
                          case Shake_screen:// 0xD62A,
                               vcEvent_comand.push_back(EventcommandShake_screen(ChunkInfo.ID,depth,Stream));

                               break;
                          case Pan_screen:// 0xD634,
                               vcEvent_comand.push_back(EventcommandPan_screen(ChunkInfo.ID,depth,Stream));

                               break;
                          case Weather_Effects:// 0xD63E,
                               vcEvent_comand.push_back(EventcommandWeather_Effects(ChunkInfo.ID,depth,Stream));

                               break;
                          case Show_Picture:// 0xD666,
                               vcEvent_comand.push_back(EventcommandShow_Picture(ChunkInfo.ID,depth,Stream));

                               break;
                         case Move_Picture:// 0xD670,
                               vcEvent_comand.push_back(EventcommandMove_Picture(ChunkInfo.ID,depth,Stream));
                               break;
                          case Erase_Picture:// 0xD67A,
                               vcEvent_comand.push_back(EventcommandErase_Picture(ChunkInfo.ID,depth,Stream));

                               break;
                          case Show_Battle_Anim :// 0xD74A,
                               vcEvent_comand.push_back(EventcommandShow_Battle_Anim(ChunkInfo.ID,depth,Stream));

                               break;
                          case Set_hero_opacity:// 0xD82E,
                               vcEvent_comand.push_back(EventcommandSet_hero_opacity(ChunkInfo.ID,depth,Stream));

                               break;
                          case Flash_event:// 0xD838,
                               vcEvent_comand.push_back(EventcommandFlash_event(ChunkInfo.ID,depth,Stream));

                               break;
                          case Move_event:// 0xD842,
                               vcEvent_comand.push_back(EventcommandMove_event(ChunkInfo.ID,depth,Stream));
                          ...
                          case Stop_all_movement:// 0xD856,
                               ...
                               break;
                          case Wait:// 0xD912,
                               vcEvent_comand.push_back(EventcommandWait(ChunkInfo.ID,depth,Stream));

                               break;
                          case Play_BGM:// 0xD976,
                               vcEvent_comand.push_back(EventcommandPlay_BGM(ChunkInfo.ID,depth,Stream));

                               break;
                          case Fade_out_BGM:// 0xDA00,
                               vcEvent_comand.push_back(EventcommandFade_out_BGM(ChunkInfo.ID,depth,Stream));
                          ...
                          case Play_sound_effect:// 0xDA1E,
                               vcEvent_comand.push_back(EventcommandPlay_SE(ChunkInfo.ID,depth,Stream));

                               break;
                          case Play_movie:// 0xDA28,
                               vcEvent_comand.push_back(EventcommandPlay_movie(ChunkInfo.ID,depth,Stream));

                               break;
                          case Key_input:// 0xDA5A,
                               vcEvent_comand.push_back(EventcommandKey_input(ChunkInfo.ID,depth,Stream));

                               break;
                          case Change_tile_set:// 0xDB3E	,
                               vcEvent_comand.push_back(EventcommandChange_tile(ChunkInfo.ID,depth,Stream));

                               break;
                          case Change_background:// 0xDB48,
                               vcEvent_comand.push_back(EventcommandChange_background(ChunkInfo.ID,depth,Stream));

                               break;
                          case Change_encounter_rate:// 0xDB5C,
                               vcEvent_comand.push_back(EventcommandChange_encounter_rate(ChunkInfo.ID,depth,Stream));

                               break;
                          case Change_single_tile:// 0xDB66,
                               vcEvent_comand.push_back(EventcommandChange_single_tile(ChunkInfo.ID,depth,Stream));

                               break;
                          case Set_teleport_location:// 0xDC22,
                               vcEvent_comand.push_back(EventcommandSet_teleport_location(ChunkInfo.ID,depth,Stream));

                               break;
                          case Enable_teleport:// 0xDC2C,
                               vcEvent_comand.push_back(EventcommandEnable_teleport(ChunkInfo.ID,depth,Stream));

                               break;
                          case Set_escape_location:// 0xDC36,
                               vcEvent_comand.push_back(EventcommandSet_escape_location(ChunkInfo.ID,depth,Stream));

                               break;
                          case Enable_escape:// 0xDC40,
                               vcEvent_comand.push_back(EventcommandEnable_escape(ChunkInfo.ID,depth,Stream));
                          ...
                          case Enable_saving:// 0xDD1A,
                               vcEvent_comand.push_back(EventcommandEnable_saving(ChunkInfo.ID,depth,Stream));
                          ...
                          case Enable_system_menu:// 0xDD38,
                               vcEvent_comand.push_back(EventcommandEnable_system_menu(ChunkInfo.ID,depth,Stream));

                               break;
                          case Conditional:// 0xDD6A,
                               vcEvent_comand.push_back(EventcommandConditional(ChunkInfo.ID,depth,Stream));
                          ...
                          case End_conditional:// 0x81AB7B,
                               ...
                               break;
                          case Label:// 0xDE4E,
                               vcEvent_comand.push_back(EventcommandLabel(ChunkInfo.ID,depth,Stream));

                               break;
                          case Go_to_label:// 0xDE58,
                               vcEvent_comand.push_back(EventcommandGo_to_label(ChunkInfo.ID,depth,Stream));
                          ...
                          case Call_event:// 0xE02A,
                               vcEvent_comand.push_back(EventcommandCall_event(ChunkInfo.ID,depth,Stream));

                               break;
                          case Comment:// 0xE07A,
                               vcEvent_comand.push_back(EventcommandComment_Text(ChunkInfo.ID,depth,Stream));

                               break;
                          case Add_line_to_comment:// 0x81AF0A,
                               vcEvent_comand.push_back(EventcommandAdd_line_to_comment(ChunkInfo.ID,depth,Stream));
                          ...
                          case Change_Profetion:// 0xE104,
                               vcEvent_comand.push_back(EventcommandChange_Profetion(ChunkInfo.ID,depth,Stream));

                               break;
                          case Change_Batle_Comands:// 0xE15E,
                               vcEvent_comand.push_back(EventcommandChange_Batle_Comands(ChunkInfo.ID,depth,Stream));
