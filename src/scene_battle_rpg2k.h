...
protected:
	 ...
	 */
	void PushGoldReceivedMessage(Game_Message::PendingMessage& pm, int money);
	 ...
	 */
	void PushExperienceGainedMessage(Game_Message::PendingMessage& pm, int exp);
	 ...
	 */
	void PushItemRecievedMessages(Game_Message::PendingMessage& pm, std::vector<int> drops);
